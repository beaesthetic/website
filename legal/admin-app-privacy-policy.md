...
## 2. A chi e rivolta questa informativa
...
Il centro puo trattare le seguenti categorie di dati personali:
...
L'email e facoltativa e viene usata solo come dato di contatto/anagrafica se fornita o necessaria. Non viene usata per newsletter o marketing.
...
| --- | --- |
| Scheda cliente e anagrafica | Cliente attivo fino a 24 mesi dall'ultimo appuntamento; cliente inattivo conservato per ulteriori 24 mesi, salvo richiesta o necessita specifica |
| Appuntamenti e storico operativo | Come scheda cliente |
| Reminder SMS e notifiche tecniche | 90 giorni |
| Log tecnici e trace | 30 giorni |
| Backup | 30 giorni |
...
- backup protetti;
- gestione controllata di database e infrastruttura;
...
La versione aggiornata viene resa disponibile ai clienti presso il centro, tramite QR code o con altra modalita idonea.
